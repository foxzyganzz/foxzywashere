...
ig = "https://instagram.com/foxzywashere"
tt = "gada"
yt = "Foxzy Mods"
...
//━━━━━━━━━━━━━━━[ HARI HARI ]━━━━━━━━━━━━━━━\\
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			herman.sendMessage(from, teks, text, { thumbnail: gember, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"New Base FoxzyBot",previewType:"PHOTO",thumbnail:gember,sourceUrl:`https://wa.me/p/6349482305092740/6281386383559`}}})
		}
		const reply2 = (teks) => {
...
return [...text.matchAll(/@([0-9]{5,16}|0)/g)].map(v => v[1] + '@s.whatsapp.net')
			...
			function addMetadata(packname, author) {	
				if (!packname) packname = 'Bot'; if (!author) author = 'By Foxzy Was Here';	
...
const froxx = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `New Base FoxzyBot`,
                 "title": `New Base Foxzy Bot`,
...
//━━━━━━━━━━━━━━━[ BUAT BIO BOT ]━━━━━━━━━━━━━━━\\
runi = process.uptime() 
           herman.setStatus(`Foxzy Botz Aktif Selama ${kyun(runi)} `).catch((_)=>_);
...
sendButImage(from, anu,`Selamat Menggunakan Bot, Tolong Jangan Spam Jeda Minimal 3-5 Detik Kalo Di Spam Nanti Bot Eror! Hargai Owner\n${Tanggal}`, thumb, [
			...
			{buttonId: `${prefix}pay`, buttonText: { displayText: `🛒 PAY/PEMBAYARAN`, }, type: 1, },
            ]); 
break
...
│•JASA KEBUTUHAN SOSMED 
│•JASA KEBUTUHAN GAME/TOP UP
│• Jasa Pembelian Pulsa,Kuota,Voucher Games,Listrik PLN/Pascabayar/Tagihan Indihome
│• Pembelian Followers/Likes/Views/Susbcribe/Jam Tayang,Dll
│•Menerima Jasa Pembuatan Website Untuk Jualan Seperti Diatas(Jualan Folls,Pulsa,jasa top up,dll)
│•Menerima Jasa Buat Website Portofolio,Website Jualan,Website Sekolah,Website Pribadi,dll
│MENYEDIAKAN?
│>JUAL NOMOR LUAR
│>OPEN SEWA BOT
...
•Mau List Nomor Luar nya?
•PC nomor dibawah untuk minta list nya
•wa.me/6281386383559
...
│• DANA : 081386383559
│• GOPAY : 081386383559
│• QRIS ALL PAYMENT : https://l.top4top.io/p_2226w1xbi1.jpg
│
╰────`)
break
...
┣➥ *Ovo:* [6281386383559]
┃ 「 *Chat OWNER* 」
┃ > *Ingin bayar/donasi? Wa.me/6281386383559*
║│
║╰──────────────────
║ Silahkan Ketik *UP*
╠════════════════════
...
//══════════[ANIME MENU]════════════════════════════//
            ...
            if (isBanned) return reply(mess.banned)
              ...
              contentText:`Creator FoxzyWasHere`,buttons,headerType:4}
...
//══════════[ Sticker Menu ]════════════════════════════//
           case 'ttp':  
           if (isBanned) return reply(mess.banned)
                    if (!c) return reply(`Teks Nya Mana Kak?\nContoh :\n${prefix}attp Foxzy Botz Whatsapp`)
